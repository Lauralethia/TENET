...
#resultpath = 'E:/tiempo/Resultados/testKeta2/'
maxPropo = False
...
#TF_conditions = [[True,False]] # TF + Fase , solo Fase, solo TF, Cruda
...
for model_complexity in [3,2,1]: # Complejidad del modelo, puede ser 3 (5 bloques), 2 (3 bloques) o 1 (1 Bloque)
    for i,NC in enumerate(Ncomp):
        for i,tf_cond in enumerate(TF_conditions):
            ...
            asfunction_corridaSimple(datapath,resultpath,'keta',model_complexity,NC,UsarTF,UsarFase,PLACA,maxPropo) 
            asfunction_corridaSimple(datapath,resultpath,'propo',model_complexity,NC,UsarTF,UsarFase,PLACA,maxPropo) 
            asfunction_corridaSimple(datapath,resultpath,'sleep' ,model_complexity,NC,UsarTF,UsarFase,PLACA,maxPropo) 
            asfunction_corridaSimple(datapath,resultpath,'awake',model_complexity,NC,UsarTF,UsarFase,PLACA,maxPropo) 
